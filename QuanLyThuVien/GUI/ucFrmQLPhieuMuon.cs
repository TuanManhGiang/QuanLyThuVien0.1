...
namespace QuanLyThuVien
{
    public partial class ucFrmQLPhieuMuon : UserControl
    {
        ...
        public ucFrmQLPhieuMuon(DocGia docgia)
        {
            this.docgia = docgia;
            InitializeComponent();
        }
        ...
        {
            txt_MDG.Text = this.docgia.MaDocGia;
            txt_MP.Text = this.docgia.MaP.ToString();
            gridControl1.DataSource = pmBUS.GetList(int.Parse(txt_MP.Text));
